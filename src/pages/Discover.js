...
const data = [
  ...
  { id: "4", title: "Suggested Artist", concerts: [10, 11, 12], showBigImage: true },
  { id: "5", title: "Featured Artist", concerts: [13, 14, 15], showBigImage: false },
];
          ...
          <FlatList 
            ...
            renderItem={({ item }) => (
              <View style={{ marginTop: 40, backgroundColor: "#ffffff", paddingLeft: 10, paddingBottom: 10, paddingRight: 10}}>
                ...
                {item.showBigImage ? (
                  <ConcertRow concerts={item.concerts} navigation={this.props.navigation} />
                ) : (
                  <ScrollView horizontal style={{ paddingHorizontal: 10 }}>
